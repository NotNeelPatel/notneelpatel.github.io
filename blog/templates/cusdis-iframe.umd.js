!(function (t) {
  ...
  function D(t, e, n, r, o, a, s, i, c, l, d, u) {
    ...
    for (m = p; m--; ) {
      const t = u(o, a, m),
        i = n(t);
      let c = s.get(i);
      c ? r && c.p(t, e) : ((c = l(i, t)), c.c()),
        y.set(i, (h[m] = c)),
        i in g && $.set(i, Math.abs(m - g[i]));
    }
    const b = new Set(),
      x = new Set();
    function k(t) {
  ...
  function Y(t, e) {
    -1 === t.$$.dirty[0] &&
      (w.push(t), L || ((L = !0), N.then(O)), t.$$.dirty.fill(0)),
      ...
      ((f.ctx = a
        ? a(e, o.props || {}, (t, n, ...r) => {
            ...
            return (
              f.ctx &&
                i(f.ctx[t], (f.ctx[t] = o)) &&
                (!f.skip_bound && f.bound[t] && f.bound[t](o), p && Y(e, t)),
              n
            );
          })
        : []),
      ...
      function n(t, e, r) {
        ...
        for (o in e) {
          var s = r ? o.toLowerCase() : o,
            i = e[o];
          a[s] =
            s in a && "object" == typeof i ? n(a[s], i, "headers" === s) : i;
        }
        return a;
      }
      function r(t, r, o, a) {
        ...
        (i.transformRequest || []).map(function (t) {
          ...
          l &&
            ...
            ((l = JSON.stringify(l)), (c["content-type"] = "application/json"));
        var d =
  ...
  function X(e) {
    ...
    return {
      ...
      p(t, [e]) {
        2 & e && b.value !== t[1] && h(b, t[1]),
          4 & e && w.value !== t[2] && h(w, t[2]),
          1 & e && h(L, t[0]),
          8 & e &&
            q !== (q = (t[3] ? W("sending") : W("post_comment")) + "") &&
            g(O, q),
          8 & e && y(A, "cusdis-disabled", t[3]);
      },
      i: t,
      o: t,
      d(t) {
    ...
    return (
      (n = new tt({ props: { parentId: t[1].id, onSuccess: t[5] } })),
      {
        c() {
          (e = l("div")),
            H(n.$$.fragment),
            m(e, "class", "mt-4 pl-4 border-l-2 border-gray-200");
        },
        m(t, o) {
